...
const createChannel = async () => {
  ...
  try {
    ...
    useAlert(error.message || t('INBOX_MGMT.ADD.WHATSAPP.WHATSMEOW.API.ERROR_MESSAGE'));
  }
};
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3">
            <h3 class="text-sm font-medium text-blue-800">
              {{ $t('INBOX_MGMT.ADD.WHATSAPP.WHATSMEOW.INFO.TITLE') }}
            </h3>
            <p class="mt-1 text-sm text-blue-700">
              {{ $t('INBOX_MGMT.ADD.WHATSAPP.WHATSMEOW.INFO.DESCRIPTION') }}
            </p>
          </div>
        </div>
      </div>
