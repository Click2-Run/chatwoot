...
ActiveRecord::Schema[7.2].define(version: 2025_11_05_180552) do
  ...
  create_table "channel_whatsapp", force: :cascade do |t|
    ...
    t.index ["provider_connection"], name: "index_channel_whatsapp_provider_connection", where: "((provider)::text = ANY ((ARRAY['baileys'::character varying, 'zapi'::character varying, 'whatsmeow'::character varying, 'click2run'::character varying])::text[]))", using: :gin
  end
